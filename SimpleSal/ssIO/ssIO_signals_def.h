/* -- SimpleSal: ssTEA, ssUI, and ssIO | (C) 2025 TruSoft Computing LLC |  All rights reserved. --
   ...
   ---------------------------------------------------------------------------------------------------
 *
 * ssIO_signals_def.h   data and software definitions: interact with true/virtual signalers.
 *
 ---------------------------------------------------------------------------------------------------- */
#ifndef __SSIO_SIGNALS_DEF_H
#define __SSIO_SIGNALS_DEF_H
