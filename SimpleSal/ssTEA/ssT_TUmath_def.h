/* -- SimpleSal: ssTEA, ssUI, and ssIO | (C) 2025 TruSoft Computing LLC |  All rights reserved. --
   ...
   ---------------------------------------------------------------------------------------------------
 *
 * ssT_TUMath_def.h     data and software definitions: ssTEA Time math implemented as an FSM
 *
 ---------------------------------------------------------------------------------------------------- */
#ifndef __SST_TUMATH_DEF_H
#define __SST_TUMATH_DEF_H

// =================================================================================================
#ifdef SST_ONEOF_TIME_IS_AN_FSM
// -------------------------------------------------------------------------------------------------
// .\SimpleSal\ssDocs\ssTEA\Time As A Signal.note           start here to understand what math means
// -------------------------------------------------------------------------------------------------
